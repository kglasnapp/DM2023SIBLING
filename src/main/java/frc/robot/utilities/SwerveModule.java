...
public class SwerveModule {
  ...
  public static double powerRatio = SwerveModule.TURBO;
    ...
    private void resetToAbsolute() {        
      ...
      System.out.println("Module "+moduleNumber+" absolute angle = "+absolutePosition+ " getCanCoder().getDegrees() - angleOffset.getDegrees() "+getCanCoder().getDegrees() +" - "+ angleOffset.getDegrees());
    ...
    private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop) {
      if (isOpenLoop) {
        ...
        driveController.setReference(
            desiredState.speedMetersPerSecond * maxSpeed / powerRatio,
            ControlType.kVelocity,
            0,
            feedforward.calculate(desiredState.speedMetersPerSecond*maxSpeed / powerRatio));
      }
    }
