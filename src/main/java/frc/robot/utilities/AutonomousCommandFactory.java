...
public class AutonomousCommandFactory {
    public static Command getAutonomousSimpleAndLeftOutCommand(DrivetrainSubsystem m_drivetrainSubsystem,
        ...
        return getAutonomousSimpleCommand(m_armSubsystem, grabberSubsystem)
          .andThen(new RobotOrientedDriveCommand(m_drivetrainSubsystem, 0, -5, 0, 750.0))
          
          .andThen(new RobotOrientedDriveCommand(m_drivetrainSubsystem, -5, 0, 0, 5500))
      ...
      public static Command getAutonomousSimpleAndRightOutCommand(DrivetrainSubsystem m_drivetrainSubsystem,
                                                    ...
                                                    GrabberSubsystem grabberSubsystem) {
        return getAutonomousSimpleCommand(m_armSubsystem, grabberSubsystem)
          .andThen(new PrintCommand("Calling to go right"))
          .andThen(new RobotOrientedDriveCommand(m_drivetrainSubsystem, 0, 5, 0, 750))
          .andThen(new PrintCommand("Going back command"))
          .andThen(new RobotOrientedDriveCommand(m_drivetrainSubsystem, -5, 0, 0, 5500))
          
          .andThen(new PrintCommand("Stop"))
          .andThen(new RobotOrientedDriveCommand(m_drivetrainSubsystem, 0, 0, 0, 500));
      }
    
      public static Command  getAutonomousSimpleCommand(ArmSubsystem m_armSubsystem, GrabberSubsystem grabberSubsystem) {        
